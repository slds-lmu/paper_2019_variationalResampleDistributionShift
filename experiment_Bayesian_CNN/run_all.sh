python main_resample_bayes.py --cv_type "vgmm" --net_type "3conv3fc" # default debug False
python main_resample_bayes.py --cv_type "rand" --net_type "3conv3fc" # default --debug False
