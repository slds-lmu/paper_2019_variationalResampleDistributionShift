...
def prepare_data(args, train_eval_list, test_list, resize):
    ...
    sys.stdout.write("| ")
    if args.debug == True:
        train_eval_set = refactor_dataset_class.SubdomainDataset(config_volatile=config_parent, list_idx=train_eval_list, transform=transform_train)
        ...
        testset = refactor_dataset_class.SubdomainDataset(config_volatile=config_parent, list_idx=test_list, transform=transform_test)
