...
\icmltitle{Submission and Formatting Instructions for
           the ICML Workshop \\ on Uncertainty and Robustness in Deep Learning (ICML UDL 2019)}
...
Submission to \textit{ICML 2019 workshop on Uncertainty and Robustness in Deep Learning} will be entirely electronic.%, via a web site (not email). 
Information about the submission process and \LaTeX\ templates
are available on the workshop web site:
\begin{center}
\textbf{\texttt{\url{https://sites.google.com/view/udlworkshop2019/}}}
\end{center}
